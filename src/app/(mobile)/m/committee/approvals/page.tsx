...
const STATUS_CONFIG: Record<string, { label: string; color: string; bg: string; dot: string }> = {
  ...
  committee_vice_reviewing: { label: '부위원장검토중', color: 'text-fuchsia-700',  bg: 'bg-fuchsia-50',  dot: 'bg-fuchsia-400' },
  approved:                 { label: '최종승인',       color: 'text-green-700',    bg: 'bg-green-50',    dot: 'bg-green-500' },
